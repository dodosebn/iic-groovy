...
export function FormSurvey3({ survey }: { survey: Survey }) {
            ...
            <div key={idx} className="flex flex-col gap-4">
              ...
              {q.type === 'text' && (
                <input
                  type="text"
                  name={`question-${idx}`}
                  className="border-b border-gray-500 py-2 px-1 w-full focus:border-b-pink-500 focus:outline-none focus:ring-0 text-gray-700"
              ...
              {q.type === 'textarea' && (
                <textarea
                  name={`question-${idx}`}
                  className="border border-gray-500 py-3 px-1 w-full  focus:outline-none focus:ring-0 text-gray-700"
                  rows={4}
                  onChange={handleChange}
                  value={formData[`question-${idx}`] || ''}
                />
