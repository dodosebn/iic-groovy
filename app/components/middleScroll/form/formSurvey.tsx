...
export function FormSurvey({ survey }: { survey: Survey }) {
    ...
    <>
      ...
      <div className="w-full max-w-2xl mx-auto py-10 flex flex-col gap-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <div key={idx} className="flex flex-col gap-4">
              ...
              {q.type === 'text' && (
                <input
                  type="text"
                  name={`question-${idx}`}
                  className="border border-gray-500 rounded-md py-2 px-3 w-full focus:border-pink-500
                   focus:ring-pink-300 text-gray-700"
              ...
              {q.type === 'textarea' && (
                <textarea
                  name={`question-${idx}`}
                  className="border border-gray-500 rounded-md py-3 px-3 w-full
                   focus:border-pink-500  focus:ring-pink-300 text-gray-700"
                  rows={4}
                  onChange={handleChange}
                  value={formData[`question-${idx}`] || ''}
                />
              ...
              {q.type === 'rating' && (
                <div className="m-2">
                  <input
                    ...
                    min={1}
                    max={5}
                    className="border border-gray-300 rounded-md py-2 px-3 w-full focus:border-pink-500 focus:ring-2 focus:ring-pink-300 text-gray-700"
                    onChange={handleChange}
                    value={formData[`question-${idx}`] || ''}
                  />
                </div>
          ...
          <button
            type="submit"
            className="mt-4 bg-pink-600 text-white font-bold py-3 px-6 rounded-4xl hover:bg-pink-700 
