...
const HomeWrapper: React.FC<HomeWrapperProps> = ({
  ...
  return (
    <div>
      <main>
        <div
          className="mx-auto flex flex-col justify-between h-full rounded-xl border border-[rgb(0,0,0)]"
        ...
        >
          <section className="flex flex-col gap-5 p-5">
              ...
              <div className="relative">
                ...
                >
                  <Image
                    src={pics}
                    alt="Article visual"
                    className="w-full h-[78%] object-cover [object-position:center_30%] rounded-t-2xl border-1 border-[#333]"
                    priority
                  />
                </Link>
            ...
            <div className="flex flex-col w-full">
              {(date || img || imgName) && (
                <div className="flex items-center justify-between space-x-3 text-gray-600 font-semibold text-sm">
                  {date && (
                    <div>
                      <p>{date}</p>
                    </div>
            ...
            <div className="flex mt-5 lg:pt-1 flex-col items-center justify-center">
